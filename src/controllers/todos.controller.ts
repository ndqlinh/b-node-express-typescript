...
export const createTodo = async (event: any, _context: any, callback): Promise<any> => {
  const { ownerId } = event;
...
export const updateTodo = async (event: any, _context: any, callback): Promise<any> => {
  const { ownerId } = event;
...
export const getTodos = async (event: any, _context: any, callback): Promise<any> => {
  const { ownerId } = event;
  const todo = new TodoService();
...
export const findTodo = async (event: any, _context: any, callback): Promise<any> => {
  const { id } = event.pathParameters;
  const result = await todo.find(id);
  return BaseResponse.toSuccess(result);
};

export const deleteTodo = async (event: any, _context: any, callback): Promise<any> => {
  const { id } = event.body;
